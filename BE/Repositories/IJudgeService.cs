...
public interface IJudgeService
{
    ...
    /// </summary>
    /// <param name="submissions">A DTO which contains a list of submissions <see cref="SubmissionDto"/></param>
    /// <returns>A list with the tokens and respective statuses</returns>
    Task<List<SubmissionBatchResultResponse>> AddBatchSubmissions(SubmissionBatchDto submissions);
}